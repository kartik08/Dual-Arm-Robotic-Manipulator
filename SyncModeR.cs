...
public class SyncModeR : MonoBehaviour
{
    ...
    void Start()
    {
        c = gameObject.GetComponent<CalcIKsldr>();
        ...
        field[1].text = "0";
        field[2].text = "0";
        px1 = c.S_Slider.value;
        py1 = c.L_Slider.value;
        pz1 = c.U_Slider.value;
        //px1 = c.x_coord;
        //py1 = c.y_coord;
        //pz1 = c.z_coord;
        rx1 = c.R_Slider.value;
        ry1 = c.B_Slider.value;
        rz1 = c.T_Slider.value;
    ...
    void Update()
    {
        ...
        //px = px1 + S_Slider.value;
        //py = py1 + L_Slider.value;
        //pz = pz1 + U_Slider.value;
